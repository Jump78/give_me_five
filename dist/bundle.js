...
/***/ function(module, exports, __webpack_require__) {
	...
	function init() {
		...
		var students = (0, _data.load_students)();
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.get_selected_student = exports.init = undefined;
	...
	var student_selected = null;

	var id_card_selected = null;

	var $original_card = null;

	var $original_sign_up_card = null;

	function init(students) {

		students_array = students;

		$original_card = (0, _jquery2.default)('#student-list li:first').detach();

		$original_sign_up_card = (0, _jquery2.default)('#student-list li').detach();

		for (var i = 0; i < students.length; i++) {

			var $clone = $original_card.clone();
		...
		(0, _jquery2.default)('#date').text(day + ".");

		(0, _jquery2.default)('#add_student').on('click', function () {
			add_panel();
		});

		(0, _jquery2.default)('#detailled_card #delete').on('click', function () {
	...
	function add_panel() {
		var $sign_up_clone = $original_sign_up_card.clone();
		$sign_up_clone.id = (0, _jquery2.default)('#student-list li').length;
		(0, _jquery2.default)('#student-list ul').append($sign_up_clone);

		$sign_up_clone.find('.validate').on('click', [$sign_up_clone], add_student);
	}
	...
	function delete_student(id) {
		...
		(0, _jquery2.default)('#detailled_card').hide();

		(0, _data.set_student_save)(students_array);
	}

	function update_card(balise, student) {
		if (student.second_name) balise.find('.card_second_name').text(student.second_name);

		if (student.name) balise.find('.card_name').text(student.name);

		if (typeof student.score === 'number') balise.find('.card_score').text(student.score + ' point(s)');

		if (student.icone) balise.find('.avatar').css('background-image', 'url(' + student.icone + ')');
	...
	function validate_form(balise, student) {
		var statut = balise.find('input[type=radio]:checked').val();
	...
	exports.init = init;
	exports.get_selected_student = get_selected_student;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.update = exports.init = undefined;
	...
	function init() {
		$card = (0, _jquery2.default)('#detailled_card');

		$stat_container = $card.find('.container_stat');

		$stat_container.find('.stat_increase').on('click', function () {
			var indice = (0, _jquery2.default)(this).parents('.row').index();
			var student = (0, _student_list.get_selected_student)();
			var prop = Object.keys(student.stat);
	...
	function update(student) {
		...
		for (var stat in student.stat) {
			...
			var property_name = student.show_property_name_as_name(stat);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function () {
		function _class(name, second_name, icone) {
		...
		_createClass(_class, [{
			...
			key: 'update_stat',
			value: function update_stat(stat, nb) {
				var nb_point = this.stat[stat] + nb;

				if (nb_point >= 0) this.stat[stat] += nb;
				this.update_score();
			}
		}, {
			key: 'show_property_name_as_name',
			value: function show_property_name_as_name(name) {
				var result = '';
				switch (name) {
					case 'presence':
						result = 'Présence';
			...
			key: 'show_property_name_as_adjective',
			value: function show_property_name_as_adjective(name) {
				var result = '';
				switch (name) {
					case 'presence':
						result = 'Présent';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.load_students = exports.set_student_save = exports.barem = undefined;
	...
	function set_student_save(students) {
		...
		for (var i = 0; i < students.length; i++) {
			for (var prop in students[i]) {
				...
				var stat_save = '';
				for (var stat in students[i].stat) {
					stat_save += stat + '+';
	...
	function load_students() {
		...
		for (var i = 0; i < object_split.length - 1; i++) {
			...
			for (var j = 0; j < stat_split.length - 1; j++) {
				var stat_prop_split = stat_split[j].split('+');
	...
	exports.barem = barem;
	exports.set_student_save = set_student_save;
